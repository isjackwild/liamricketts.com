...
class StoryItem extends React.Component {
	...
	update(e, force) {
		...
		// if (scrollPosition < minIn && force < 0) scrollPosition = this.props.scrollMax + minIn;
		// if (scrollPosition > maxIn && force > 0) scrollPosition = (this.props.scrollMax - maxIn) * -1
		
		// if (rect.right < 0 && force < 0) scrollPosition = this.props.scrollMax;
		// if (rect.left > 0 && force > 0) scrollPosition = this.props.scrollMax * -1;

		if (scrollPosition < (this.props.scrollMax * -1) && force < 0) scrollPosition = 0;
		if (scrollPosition > 0 && force > 0) scrollPosition = this.props.scrollMax * -1;
